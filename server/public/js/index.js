	  ...
	  _createClass(Lottery, [{
	    ...
	    value: function updateState() {
	      ...
	      this.getState().then(function (res) {
	        self.issue = red.issue;
	        self.end_time = res.end_time;
	        self.state = res.state;
	        (0, _jquery2.default)(self.issue_el).html(time);
	        self.countdown(res.end_time, function (time) {
	          ...
	          setTimeout(function () {
	            ...
	            self.getOpenCode(self.issue).then(function (res) {}, 500);
	          });
	        });
	      });
	    }
	  ...
	  _createClass(Base, [{
	    ...
	    value: function getCount() {
	      ...
	      if (count === 0) {
	        ...
	        tpl = '\u60A8\u9009\u4E86 < b > ' + count + '</b > \u6CE8\uFF0C\u5171 < b > ' + count * 2 + '</b > \u5143 < em > \u82E5\u4E2D\u5956\uFF0C \u5956\u91D1:\n      <strong class=" red">' + range[0] + '</strong>\u81F3 < strong class=" red" > ' + range[1] + '</strong > \u60A8\u5C06' + (win1 < 0 && win2 < 0 ? '亏损' : '盈利') + '\n      <strong class="' + (win1 >= 0 ? 'red' : 'green') + '">' + c1 + ' </st rong >\n        \u81F3 < strong class="' + (win2 >= 0 ? ' red' : 'green') + '" > ' + c1 + ' </st rong > \u5143</ em > "';
	      }
	  ...
	  _createClass(Calculate, [{
	    ...
	    value: function computeBonus(active, play_name) {
	      ...
	      return [min, max].map(function (item) {
	        return item * self.play_list.get(play_list).bonus;
	      });
	    }
	  }], [{
	    key: 'combine',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Interface = function () {
	  ...
	  _createClass(Interface, [{
	    ...
	    key: 'gitOpenCode',
	    value: function gitOpenCode(issue) {
	      var self = this;
	      return new Promise(function (resolve, reject) {
	        $ajax({
	          url: '/get/pencode',
